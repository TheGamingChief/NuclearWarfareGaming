...
class_public = [ // These are visible to anyone on the server
	...
	[(localize "str_playerstats_bandit")+" Lvl3","GUE_Soldier_MG_DZ","SurvivorW2_DZ",[START_ITEMS,"gms_k98_mag",2,"30Rnd_9x19_UZI_SD",3],["gms_k98zf39","UZI_SD_EP1",TOOLBELT_ITEMS],"DZ_TK_Assault_Pack_EP1",[],[],0,-10000,0,""],
	[(localize "str_playerstats_hero")+" Lvl1",if (class_epoch) then {"Drake_Light_DZ"} else {"Survivor3_DZ"},"SurvivorW2_DZ",[START_ITEMS,"20Rnd_556x45_Stanag",2,"30Rnd_9x19_UZI_SD",3],["G36C","UZI_SD_EP1",TOOLBELT_ITEMS],"DZ_TerminalPack_EP1",[],[],0,5000,0,""],
	[(localize "str_playerstats_hero")+" Lvl2",if (class_epoch) then {"Rocket_DZ"} else {"Survivor3_DZ"},"SurvivorW2_DZ",[START_ITEMS,"20Rnd_556x45_Stanag",2,"30Rnd_9x19_UZI_SD",3],["M4A1_HWS_GL_camo","UZI_SD_EP1",TOOLBELT_ITEMS],"DZ_British_ACU",[],[],0,10000,0,""],
	[(localize "str_playerstats_hero")+" Lvl3",if (class_epoch) then {"CZ_Special_Forces_GL_DES_EP1_DZ"} else {"Survivor3_DZ"},"SurvivorW2_DZ",[START_ITEMS,"20Rnd_762x51_DMR",2,"30Rnd_9x19_UZI_SD",3],["RH_m1stsp","UZI_SD_EP1",TOOLBELT_ITEMS],"DZ_CivilBackpack_EP1",[],[],0,25000,0,""],
	[localize "str_playerstats_survivor","Survivor2_DZ","SurvivorW2_DZ",[START_ITEMS,"RH_8Rnd_9X19_Mksd",3],["RH_mk22sd","MeleeBaseBallBat",TOOLBELT_ITEMS],"DZ_Patrol_pack_EP1",[],[],0,0,0]
];
