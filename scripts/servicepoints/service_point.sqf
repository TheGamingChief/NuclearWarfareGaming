...
_servicePointClasses = ["Map_A_FuelStation_Feed","Land_A_FuelStation_Feed","Land_benzina_schnell","Land_fuelstation_army","FuelPump_DZ"]; // service point classes, You can also use dayz_fuelpumparray by its self for all the default fuel pumps.
...
_refuel_costs = [
	["Land",500], // All land vehicles are free to refuel. Free has to be in ""
...
_repair_costs = [
	["Air",7000], // 4000 worth is 4 10oz gold.
	["AllVehicles",2500] // 2000 worth is 2 10oz gold for all other vehicles
];
