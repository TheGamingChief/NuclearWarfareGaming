...
DZE_CLICK_ACTIONS = [
    ...
    ["ItemGPS","Toggle Map Marker","execVM 'scripts\click_actions\examples\marker.sqf';","true"],
    ["ItemMap","Toggle Map Marker","execVM 'scripts\click_actions\examples\marker.sqf';","true"],
	["ItemKnife","Harvest Weed","execVM 'scripts\drugs\cuthemp.sqf';","true"],
	["ItemMachete","Harvest Weed","execVM 'scripts\drugs\cuthemp.sqf';","true"],
	["ItemKiloHemp","Smoke Weed","execVM 'scripts\drugs\smoke.sqf';","true"]
];