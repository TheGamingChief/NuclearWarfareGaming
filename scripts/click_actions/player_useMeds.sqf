...
switch (_item) do {
	...
	case "wholeBloodBagANEG": {
		_id = [player,"wholeBloodBagANEG"] execVM "custom\selfbloodbag.sqf";
	};
	case "wholeBloodBagAPOS": {
		_id = [player,"wholeBloodBagAPOS"] execVM "custom\selfbloodbag.sqf";
	};
	case "wholeBloodBagBNEG": {
		_id = [player,"wholeBloodBagBNEG"] execVM "custom\selfbloodbag.sqf";
	};
	case "wholeBloodBagBPOS": {
		_id = [player,"wholeBloodBagBPOS"] execVM "custom\selfbloodbag.sqf";
	};
	case "wholeBloodBagABNEG": {
		_id = [player,"wholeBloodBagABNEG"] execVM "custom\selfbloodbag.sqf";
	};
	case "wholeBloodBagABPOS": {
		_id = [player,"wholeBloodBagABPOS"] execVM "custom\selfbloodbag.sqf";
	};
	case "wholeBloodBagONEG": {
		_id = [player,"wholeBloodBagONEG"] execVM "custom\selfbloodbag.sqf";
	};
	case "wholeBloodBagOPOS": {
		_id = [player,"wholeBloodBagOPOS"] execVM "custom\selfbloodbag.sqf";
	};
	case "ItemBloodbag": {
		_id = [player,"ItemBloodbag"] execVM "custom\selfbloodbagitembloodbag.sqf";
	};
};
