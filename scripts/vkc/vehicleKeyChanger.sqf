...
_claimPrice = 5000; // Amount in worth for claiming a vehicle. See the top of this script for an explanation.
_changePrice = 10000; // Amount in worth for changing the key for a vehicle. See the top of this script for an explanation.
