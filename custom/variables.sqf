...
ZSC_MaxMoneyInStorageMultiplier = 250; // Multiplier for how much money a bank object can hold, example: 200 magazine slots in the object (or the default value above ^^) multiplied by the 50,000 multiplier is 10 million coin storage. (200*50000=10m coins)
Z_bankVariable = "moneySpecial"; // If using single currency this is the variable name used to store object bank wealth.
Z_globalVariable = "GlobalMoney"; // If using single currency this is the variable name used to store coins globally.
...
DZE_safeZonePosArray = [
	//[[X,Y],radius]
 	[[4425,1623],100], //Pikia
	[[8681,3127],100], //Selca
	[[4325,6313],100], //Planica
	[[2246,9478],100], //Mello Vehicle/Parts Vendors
	[[841,9248],50], //Black Market
	[[3356,2315],100], //Southern Boat Dealer
	[[3801,7653],100], //Northern Boat Dealer
	[[9052,4056],100], //Hero Dealer
	[[1908,3607],100] //Bandit Dealer
];