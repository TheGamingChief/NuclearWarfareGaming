...
dayZ_serverName = "[NWG]"; //Shown to all players in the bottom left of the screen (country code + server number)
...
call compile preprocessFileLineNumbers "custom\variables.sqf"; //For Single Currency 
...
call compile preprocessFileLineNumbers "custom\compiles.sqf"; //For Single Currency 
call compile preprocessFileLineNumbers "scripts\click_actions\init.sqf"; //Adds click actions
call compile preprocessFileLineNumbers "scripts\bike\init.sqf"; //Adds deployable bikes / other items
if (_verCheck) then {
	#include "DZE_Hotfix_1.0.6.1A\init\compiles.sqf"
};
progressLoadingScreen 0.25;
//call compile preprocessFileLineNumbers "server_traders.sqf";
call compile preprocessFileLineNumbers "scripts\traders\server_traders.sqf"; //For Single Currency 
...
if (!isDedicated) then {
	...
	call compile preprocessFileLineNumbers "scripts\spawn\init.sqf";
	execFSM "\z\addons\dayz_code\system\player_monitor.fsm";
	//[false,12] execVM "\z\addons\dayz_code\compile\local_lights_init.sqf";
	if (DZE_R3F_WEIGHT) then {execVM "\z\addons\dayz_code\external\R3F_Realism\R3F_Realism_Init.sqf";};
	//Custom Scripts (Initialized client side)
	...
	[] execvm "scripts\misc\TraderProtection.sqf";
	[] execVM "scripts\servicepoints\service_point.sqf";
	[] execVM "custom\remote_message.sqf";
